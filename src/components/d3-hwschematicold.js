(function(global, factory) {
  ...
  ELK =
    ELK && Object.prototype.hasOwnProperty.call(ELK, "default")
      ? ELK["default"]
      : ELK;
  ...
  class GenericNodeRenderer {
    ...
    renderTextLines(bodyTexts) {
      ...
      bodyTexts.each(function() {
        ...
        if (
          bodyTextLines &&
          (d.children == null || d.children.length == 0 || d.hideChildren)
        ) {
  ...
  class d3elk {
    ...
    copyElkProps(srcGraph, dstGraph) {
      ...
      (dstGraph.edges || []).forEach(function(e) {
        if (e.id in d3Objs) throw new Error(JSON.stringify(e));
        d3Objs[e.id] = e;
      });
